...
# If defined, ADD_CONVENIENCE_LIBRARY2 does not add PIC flag to compile flags
#
# - DISABLE_SHARED: If set, it is assumed that shared libraries are not produced
# during the build. ADD_CONVENIENCE_LIBRARY2 does not add anything to compile flags
...
# CREATE_EXPORT_FILE2 (VAR target api_functions)
...
MACRO(CREATE_EXPORT_FILE2 VAR TARGET API_FUNCTIONS)
...
# ADD_CONVENIENCE_LIBRARY2(name source1...sourceN)
...
MACRO(ADD_CONVENIENCE_LIBRARY2)
  SET(TARGET ${ARGV0})
  SET(SOURCES ${ARGN})
...
MACRO(ADD_IMPORTED_LIBRARY2 TARGET LOC)
      ...
      FOREACH(LIB ${LIBS})
        ...
        IF(LIBTYPE STREQUAL "STATIC_LIBRARY")
          ...
          IF(NOT LIB_COMPILE_FLAGS MATCHES "<PIC_FLAG>")
            ...
            "Please use ADD_CONVENIENCE_LIBRARY2, instead of ADD_LIBRARY for ${LIB}"
            )
          ENDIF()
        ENDIF()
      ENDFOREACH()
    ENDIF()
    CREATE_EXPORT_FILE2(SRC ${TARGET} "${ARG_EXPORTS}")
    IF(UNIX)
...
MACRO(MERGE_CONVENIENCE_LIBRARIES2)
  MYSQL_PARSE_ARGUMENTS(ARG
