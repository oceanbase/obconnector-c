...
enum ObClientAttributeCapabilityFlag
{
  OBCLIENT_CAP_OB_LOB_LOCATOR_V2 = 0,
  OBCLIENT_CAP_NEW_RESULT_META_DATA = 1,
  OBCLIENT_CAP_SUPPORT_JDBC_BINARY_DOUBLE
};
#define OBCLIENT_CAP_OB_LOB_LOCATOR_V2 OBCLIENT_CAP_GET_TYPE(OBCLIENT_CAP_OB_LOB_LOCATOR_V2)
#define OBCLIENT_CAP_NEW_RESULT_META_DATA OBCLIENT_CAP_GET_TYPE(OBCLIENT_CAP_NEW_RESULT_META_DATA)
#define OBCLIENT_CAP_SUPPORT_JDBC_BINARY_DOUBLE OBCLIENT_CAP_GET_TYPE(OBCLIENT_CAP_SUPPORT_JDBC_BINARY_DOUBLE)
static const unsigned long OBCLIENT_DEFAULT_CAPABILITY_FLAG = 
  (OBCLIENT_CAP_OB_LOB_LOCATOR_V2| OBCLIENT_CAP_SUPPORT_JDBC_BINARY_DOUBLE);

static const char *const OB_MYSQL_CLIENT_ATTRIBUTE_CAPABILITY_FLAG = "__ob_client_attribute_capability_flag";
